<template><div class="border border-success rounded p-2">
<main class="content">
  <h1 class="h3 mb-3">채팅방 {{this.$route.params.id}}</h1>
  <div v-if="!isLoading" class="card">
    <div class="row g-0">
      <ChatsMessage v-for="chatsMessage in chatsMessages" :key="chatsMessage.id" :chatsMessage="chatsMessage" />
    </div>
  </div>
  <p>{{ content }}</p>
  <div class="row p-1">
  <div class="col-10 p-1">
    <input class="form-control col-10" v-model="content" placeholder="채팅 메시지를 입력하세요"/>
  </div>
    <div class="col-2 p-1">
...
import ChatsMessage from "../components/ChatsMessage.vue"
export default {
  components: {
    ChatsMessage
  },
  ...
  created () {
    ...
    axios.get('http://localhost:8080/chats/' + this.$route.params.id)
    .then( (resp) => {
      this.chatsMessages = resp.data.chatsMessages
